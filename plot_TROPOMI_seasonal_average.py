...
def open_data_season(timerange, datadir='/media/tenkanen/My Passport/MethaneHotSpots/h5/'):
...
def plot_seasonal_average(xch4, ax, **kwargs):
...
if __name__ == '__main__':
    ...
    for ind, season in enumerate(xch4_seasonal_average.time):
        ...
        im = plot_seasonal_average(xch4_seasonal_average[var].sel(
            time=season), ax, levels, cmap, label)
        ...
        plt.savefig(
            f'Figures/tropomi_3month_average_{start_date}_{end_date}.png', dpi=150, bbox_inches='tight')
        plt.show()
